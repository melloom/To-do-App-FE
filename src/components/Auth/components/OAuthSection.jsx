...
const OAuthSection = ({ 
  ...
  return (
    <div className="oauth-section">
      ...
      <div className="oauth-consent-indicator">
        ...
        <div className="oauth-consent-features">
          <div className="oauth-consent-item">
            <span className="oauth-consent-icon">✅</span>
            <span className="oauth-consent-text">
              Permission consent required for <span className="oauth-provider-name">profile access</span>
            </span>
          </div>
          <div className="oauth-consent-item">
